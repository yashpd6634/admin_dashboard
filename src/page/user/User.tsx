        ...
        <div className={classes.userContainer}>
            <div className={classes.userShow}>
                <div className={classes.userShowTop}>
                    <img src="https://images.pexels.com/photos/1152994/pexels-photo-1152994.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" alt='' className={classes.userShowImg}/>
                    <div className={classes.userShowTopTitle}>
                        <span className={classes.userShowUsername}>Anna Becker</span>
                        <span className={classes.userShowUserTitle}>Software Engineer</span>
                    </div>
                </div>
                <div className={classes.userShowBottom}>
                    ...
                    <div className={classes.userShowInfo}>
                        ...
                        <span className={classes.userShowInfoTitle}>annabeck99@gmail.com</span>
                    </div>
                    <div className={classes.userShowInfo}>
            ...
            <div className={classes.userUpdate}>
                ...
                <form action="" className={classes.userUpdateForm}>
                    <div className={classes.userUpdateLeft}>
                        ...
                        <div className={classes.userUpdateItem}>
                            <label>Email</label>
                            <input type="text" placeholder="annabeck99@gmail.com" className={classes.userUpdateInput}/>
                        </div>
                        <div className={classes.userUpdateItem}>
                            <label>Phone</label>
                            <input type="text" placeholder="+1 123 456 67" className={classes.userUpdateInput}/>
                        </div>
                        <div className={classes.userUpdateItem}>
                            <label>Address</label>
                            <input type="text" placeholder="New York | USA" className={classes.userUpdateInput}/>
                        </div>
                    </div>
